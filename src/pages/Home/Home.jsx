...
console.log(cntry);
  ...
  <InputLabel  className={`${mode ? "eep" : ""} demo-simple-select-label`} >Region</InputLabel>
  <Select
  ...
  >
    ...
    <MenuItem value={'Europe'}>Europe</MenuItem>
        ...
        <div className={`${mode ? "dark" : ""} cd`}>
               {paginateresult&& paginateresult?.map((detail)=><Countrycode mode={mode} country={detail}  key={detail?.area}/>)}
        </div>
